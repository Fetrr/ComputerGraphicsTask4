...
class ObjReaderTest {
    ...
    public void testParseFaceWord01(){
        ...
        ArrayList<Integer> expectedList1 = new ArrayList<>(List.of(1));
        ArrayList<Integer> expectedList2 = new ArrayList<>(List.of());
        ArrayList<Integer> expectedList3 = new ArrayList<>(List.of(2));
    ...
    public void testParseFace01() throws IncorrectFileException {
        ...
        Polygon expectedPolygon = new Polygon(new ArrayList<>(Arrays.asList(1, 6, 2)), new ArrayList<>(Arrays.asList(1, 2, 5)), new ArrayList<>(Arrays.asList(2, 3, 7)));
        Polygon polygon = ObjReader.parseFace(wordsInLineWithoutToken, 10);
        Assertions.assertEquals(polygon, expectedPolygon);
    }
    //wrong index
    @Test
    ...
    public void testParseFace05() {
        ...
        Polygon expectedPolygon = new Polygon(new ArrayList<>(Arrays.asList(1, 6, 2)), new ArrayList<>(List.of()), new ArrayList<>(Arrays.asList(2, 3, 7)));
        Polygon polygon = ObjReader.parseFace(wordsInLineWithoutToken, 10);
        Assertions.assertEquals(polygon, expectedPolygon);
    }
}